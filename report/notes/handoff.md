...
- Person C: NVIDIA RTX 500 (8 GB) — runs all of nb03 (CaFE loops process one image at a time, fits in 8 GB)
...
### 1. Implement 4 figure stubs — `src/visualise.py` · **Prioritise in this order**
