...
### SAE Feature Analysis in ViTs: From Concept Discovery to CaFE Validation
...
We analyze sparse autoencoder features for a contrastive visual discrimination behavior in DINOv2. The project focuses on SAE concept discovery, CLIP-based feature labeling, Monosemanticity Score analysis, causal feature ranking, and CaFE-style validation that important features are grounded at the right spatial location.
...
src/
  ...
  evaluate.py               SAE quality metrics                  [Person C]
